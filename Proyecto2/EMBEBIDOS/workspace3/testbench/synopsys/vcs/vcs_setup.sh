...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_rsp_demux_010.sv \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_rsp_demux.sv \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_cmd_mux_010.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_mm_interconnect_0_router_012.sv \
  ...
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_SET.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_RAM.v \
  $QSYS_SIMDIR/system_tb/simulation/submodules/system_H_1.v \
